...
Label(root, text='Made by : Mainak', bg='#4a536b', fg='#34deeb', font='Times 18 bold italic').pack()
...
Button(root, text= 'Convert', bg='yellow', fg='#000', font='Times 15 bold', command=Convert_fun).place(x=150, y=280)
